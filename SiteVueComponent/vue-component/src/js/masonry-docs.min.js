      ...
      r.docReady(function () {
        ...
        d.forEach(function (e) {
          ...
          try {
            ...
            return void (
              o &&
              o.error("Error parsing " + a + " on " + e.className + ": " + i)
            );
          }
          var c = new t(e, r);
          s && s.data(e, n, c);
...
!(function (t) {
  ...
  function n() {
    c
      ? ((o.style[c] = "opacity 1.0s"), (o.style.opacity = "0"))
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    (i.getItemElement = function () {
      var t = document.createElement("div"),
        ...
        o =
          n > 0.8 ? "grid-item--height3" : n > 0.5 ? "grid-item--height2" : "";
      return (t.className = "grid-item " + i + " " + o), t;
    });
  var r,
    a = document.documentElement,
    c =
      "string" == typeof a.style.transition ? "transition" : "WebkitTransition",
    s = c ? 1e3 : 1500;
  i.notify = function (t) {
...
MasonryDocs.hero = function (e) {
  ...
  function t(e) {
    ...
    return (
      (m.className = "hero__example-link__title"),
